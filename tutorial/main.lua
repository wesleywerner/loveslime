...
function cell.addEgoActor (x, y)
	...
	egoSprites.filename = "images/" .. egoSprites.filename
	...
	slime.actors:add (ego)

end

function cell.addEgoActorOld (x, y)
	----
